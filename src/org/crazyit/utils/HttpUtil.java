...
public class HttpUtil {
	...
	public static String syncRequest(final String json_syn) throws Exception,
			ExecutionException {
		final String url = BASE_URL + "/JSON_Tongbu.ashx";
		// httpClient.getParams().setLongParameter(CoreConnectionPNames.CONNECTION_TIMEOUT,
		// 3000);
		// httpClient.getParams().setLongParameter(CoreConnectionPNames.SO_TIMEOUT,
		// 3000);
